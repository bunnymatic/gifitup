  ...
  var colpick = (function() {
    var tpl =
      ...
      setSelector = function(hsb, cal) {
        ...
        $(cal)
          ...
          .selectorIndic.css({
            ...
            top: parseInt(
              ($(cal).data("colpick").height * (100 - hsb.b)) / 100,
              10
            )
          });
      },
          ...
          .hue.css(
            ...
            parseInt(
              $(cal).data("colpick").height -
                ($(cal).data("colpick").height * hsb.h) / 360,
              10
            )
          );
      },
      ...
      change = function(ev) {
        ...
        cal
          .data("colpick")
          .onChange.apply(cal.parent(), [col, hsbToHex(col), hsbToRgb(col)]);
      },
      ...
      clickSubmit = function(ev) {
        ...
        cal
          .data("colpick")
          .onSubmit(col, hsbToHex(col), hsbToRgb(col), cal.data("colpick").el);
      },
