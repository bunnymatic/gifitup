...
class Gifitup < Sinatra::Base
  ...
  get '/' do
    ...
    slim :index, layout: :layout,
                 locals: { frames: nil, background: '#000000', fonts: @fonts, font: Font.default.name, delay: 0.40 }
  end
  ...
  post '/' do
    ...
    words = WordProcessor.new(words).marquee if marquee
  ...
  def save_file(destination_fname, uploaded_file)
    ...
    File.write(dest, uploaded_file.read)
    dest
  end
end
